...
INSERT INTO LUGAR(nombre,tipo,fk_tipo) VALUES('Distrito Capital','estado',(select id from LUGAR where tipo='país' and nombre='Venezuela'));
INSERT INTO LUGAR(nombre,tipo,fk_tipo) VALUES('Miranda','estado',(select id from LUGAR where tipo='país' and nombre='Venezuela'));
INSERT INTO LUGAR(nombre,tipo,fk_tipo) VALUES('Libertador','municipio',(select id from LUGAR where tipo='estado' and nombre='Distrito Capital'));
INSERT INTO LUGAR(nombre,tipo,fk_tipo) VALUES('Sucre','municipio',(select id from LUGAR where tipo='estado' and nombre='Miranda'));
INSERT INTO LUGAR(nombre,tipo,fk_tipo) VALUES('El Hatillo','municipio',(select id from LUGAR where tipo='estado' and nombre='Miranda'));
INSERT INTO LUGAR(nombre,tipo,fk_tipo) VALUES('Baruta','municipio',(select id from LUGAR where tipo='estado' and nombre='Miranda'));
INSERT INTO LUGAR(nombre,tipo,fk_tipo) VALUES('Chacao','municipio',(select id from LUGAR where tipo='estado' and nombre='Miranda'));
INSERT INTO LUGAR(nombre,tipo,fk_tipo) VALUES('Altagracia','parroquia',(select id from LUGAR where tipo='municipio' and nombre='Libertador'));
INSERT INTO LUGAR(nombre,tipo,fk_tipo) VALUES('Antímano','parroquia',(select id from LUGAR where tipo='municipio' and nombre='Libertador'));
INSERT INTO LUGAR(nombre,tipo,fk_tipo) VALUES('23 de enero','parroquia',(select id from LUGAR where tipo='municipio' and nombre='Libertador'));
INSERT INTO LUGAR(nombre,tipo,fk_tipo) VALUES('El Junquito','parroquia',(select id from LUGAR where tipo='municipio' and nombre='Libertador'));
INSERT INTO LUGAR(nombre,tipo,fk_tipo) VALUES('La Pastora','parroquia',(select id from LUGAR where tipo='municipio' and nombre='Libertador'));
INSERT INTO LUGAR(nombre,tipo,fk_tipo) VALUES('La Vega','parroquia',(select id from LUGAR where tipo='municipio' and nombre='Libertador'));
INSERT INTO LUGAR(nombre,tipo,fk_tipo) VALUES('San José','parroquia',(select id from LUGAR where tipo='municipio' and nombre='Libertador'));
INSERT INTO LUGAR(nombre,tipo,fk_tipo) VALUES('San Agustín','parroquia',(select id from LUGAR where tipo='municipio' and nombre='Libertador'));
INSERT INTO LUGAR(nombre,tipo,fk_tipo) VALUES('San Juan','parroquia',(select id from LUGAR where tipo='municipio' and nombre='Libertador'));
INSERT INTO LUGAR(nombre,tipo,fk_tipo) VALUES('San Pedro','parroquia',(select id from LUGAR where tipo='municipio' and nombre='Libertador'));
INSERT INTO LUGAR(nombre,tipo,fk_tipo) VALUES('Santa Rosalía','parroquia',(select id from LUGAR where tipo='municipio' and nombre='Libertador'));
INSERT INTO LUGAR(nombre,tipo,fk_tipo) VALUES('El Paraíso','parroquia',(select id from LUGAR where tipo='municipio' and nombre='Libertador'));
INSERT INTO LUGAR(nombre,tipo,fk_tipo) VALUES('Caricuao','parroquia',(select id from LUGAR where tipo='municipio' and nombre='Libertador'));
INSERT INTO LUGAR(nombre,tipo,fk_tipo) VALUES('Sucre','parroquia',(select id from LUGAR where tipo='municipio' and nombre='Libertador'));
INSERT INTO LUGAR(nombre,tipo,fk_tipo) VALUES('El Valle','parroquia',(select id from LUGAR where tipo='municipio' and nombre='Libertador'));
INSERT INTO LUGAR(nombre,tipo,fk_tipo) VALUES('El Recreo','parroquia',(select id from LUGAR where tipo='municipio' and nombre='Libertador'));
INSERT INTO LUGAR(nombre,tipo,fk_tipo) VALUES('La Candelaria','parroquia',(select id from LUGAR where tipo='municipio' and nombre='Libertador'));
INSERT INTO LUGAR(nombre,tipo,fk_tipo) VALUES('Santa Teresa','parroquia',(select id from LUGAR where tipo='municipio' and nombre='Libertador'));
INSERT INTO LUGAR(nombre,tipo,fk_tipo) VALUES('Macarao','parroquia',(select id from LUGAR where tipo='municipio' and nombre='Libertador'));
INSERT INTO LUGAR(nombre,tipo,fk_tipo) VALUES('San Bernardino','parroquia',(select id from LUGAR where tipo='municipio' and nombre='Libertador'));
INSERT INTO LUGAR(nombre,tipo,fk_tipo) VALUES('Coche','parroquia',(select id from LUGAR where tipo='municipio' and nombre='Libertador'));
INSERT INTO LUGAR(nombre,tipo,fk_tipo) VALUES('El Cafetal','parroquia',(select id from LUGAR where tipo='municipio' and nombre='Baruta'));
INSERT INTO LUGAR(nombre,tipo,fk_tipo) VALUES('Las Minas','parroquia',(select id from LUGAR where tipo='municipio' and nombre='Baruta'));
INSERT INTO LUGAR(nombre,tipo,fk_tipo) VALUES('Baruta','parroquia',(select id from LUGAR where tipo='municipio' and nombre='Baruta'));
INSERT INTO LUGAR(nombre,tipo,fk_tipo) VALUES('Chacao','parroquia',(select id from LUGAR where tipo='municipio' and nombre='Chacao'));
INSERT INTO LUGAR(nombre,tipo,fk_tipo) VALUES('Leoncio Martínez','parroquia',(select id from LUGAR where tipo='municipio' and nombre='Sucre'));
INSERT INTO LUGAR(nombre,tipo,fk_tipo) VALUES('Santa Rosalía de Palermo','parroquia',(select id from LUGAR where tipo='municipio' and nombre='El Hatillo'));
